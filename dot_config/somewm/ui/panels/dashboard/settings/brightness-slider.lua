...
action_level:buttons({awful.button({}, 1, nil, function()
    action_jump()
end)})
...
function brightness_setting:keyboard_adjust(direction)
	brightness_slider:set_value(math.max(0, math.min(100, (brightness_slider:get_value() or 0) + direction * 5)))
end
