...
local function update_titlebar_visibility(c)
	local should_hide = should_hide_titlebar(c)
	if c._titlebar_hidden_state == should_hide then
		return
	end
	c._titlebar_hidden_state = should_hide
...
client.connect_signal("request::titlebars", function(c)
	-- Guard against repeated setup calls for the same client.
	if c._titlebar_setup_done then
